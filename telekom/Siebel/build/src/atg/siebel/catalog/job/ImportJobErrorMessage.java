 ...
 *
 * @author bbrady
 * @version $Id: //product/Siebel/version/11.2/src/atg/siebel/catalog/job/ImportJobErrorMessage.java#2 $$Change: 1194813 $
 * @updated $DateTime: 2015/09/10 08:26:24 $$Author: saysyed $
 */

public class ImportJobErrorMessage {

  //-------------------------------------
  /** Class version string */

  public static String CLASS_VERSION = "$Id: //product/Siebel/version/11.2/src/atg/siebel/catalog/job/ImportJobErrorMessage.java#2 $$Change: 1194813 $";
  ...
  public String toString() {
	  return "ImportJobErrorMessage [mExportItemId=" + mExportItemId + ", mType="
	      + mType + ", mMessage=" + mMessage + ", mSourceItemId=" + mSourceItemId
