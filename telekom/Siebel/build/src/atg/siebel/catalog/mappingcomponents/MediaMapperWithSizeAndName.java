...
public class MediaMapperWithSizeAndName extends BaseMapper {

  //-------------------------------------
  /** Class version string */

  public static String CLASS_VERSION = "$Id: //product/Siebel/version/11.2/src/atg/siebel/catalog/mappingcomponents/MediaMapperWithSizeAndName.java#2 $$Change: 1194813 $";


  private static final String ID_SPACE_NAME = "media";
  private static final String NAME_PROPERTY_NAME = "name";
  private static final String URL_PROPERTY_NAME = "url";
  private static final String MEDIA_SIZE_PROPERTY_NAME = "mediaSize";
  ...
  public Object mapSiebelToATG(Object pSiebelFields, Map<String, Object> pAttributes)
    ...
    String name = (String) siebelValues[0];
    String extension = (String) siebelValues[1];
    String filename = (String) siebelValues[2];
    String size = (String) siebelValues[3];
    ...
    String id = checkExistingMedia(mediaLocation, Integer.valueOf(size), name);
    
    if (id != null) {
      return id;
    }
    try {
      id = mMappingService.getIdGenerator().generateStringId(ID_SPACE_NAME);
    ...
    newMediaItem.addProperty(NAME_PROPERTY_NAME, name);
    newMediaItem.addProperty(URL_PROPERTY_NAME, mediaLocation);
    newMediaItem.addProperty(MEDIA_SIZE_PROPERTY_NAME, size);
   ...
   */
  private String checkExistingMedia(String pMediaLocation, Integer pSize, String pName)
      throws MappingException {
    ...
    Integer sizeOfExisting = (Integer) existingMedia.getPropertyValue(MEDIA_SIZE_PROPERTY_NAME);
    String nameOfExisting = (String) existingMedia.getPropertyValue(NAME_PROPERTY_NAME);
    
    if (urlOfExisting.equalsIgnoreCase(pMediaLocation) && sizeOfExisting.equals(pSize) &&
        nameOfExisting.equalsIgnoreCase(pName)) {
