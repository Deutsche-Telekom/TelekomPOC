...
public class AttributeConfigurableListMapper extends CheckExistingLinksMapper {

  //-------------------------------------
  /** Class version string */

  public static String CLASS_VERSION = "$Id: //product/Siebel/version/11.2/src/atg/siebel/catalog/mappingcomponents/AttributeConfigurableListMapper.java#2 $$Change: 1194813 $";


  private static final String SIEBEL_ORIG_ID = "OrigId";

  private static final String ATG_ORIG_ID = "origId";

  @Override
  protected String getExistingATGId(ItemData itemData) throws MappingException {
    // get the current configured attributes property from the repository
  ...
  /* (non-Javadoc)
   * @see atg.siebel.catalog.mappingcomponents.ListOfItemMapper#isValidItem(atg.siebel.catalog.mapper.ItemData)
   */
  @Override
  protected String isValidItem(ItemData itemData) {
    /*Object origIdObj = itemData.getProperties().get(SIEBEL_ORIG_ID);
    if (origIdObj == null) {
      return "OrigId field is null";
    }*/
    return "";
  }
}
