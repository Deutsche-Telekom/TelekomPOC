...
public class SingleChoiceSingleSelectRule extends RelationshipRendererRule
{

  //-------------------------------------
  /** Class version string */

  public static String CLASS_VERSION = "$Id: //product/Siebel/version/11.2/src/atg/siebel/configurator/spu/generation/rules/SingleChoiceSingleSelectRule.java#2 $$Change: 1194813 $";
