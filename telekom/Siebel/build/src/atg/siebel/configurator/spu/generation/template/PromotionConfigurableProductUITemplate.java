 ...
 * @version $Id: //product/Siebel/version/11.2/src/atg/siebel/configurator/spu/generation/template/PromotionConfigurableProductUITemplate.java#2 $$Change: 1194813 $
...
public class PromotionConfigurableProductUITemplate extends ConfigurableProductUITemplate
{
  ...
  public static String CLASS_VERSION = "$Id: //product/Siebel/version/11.2/src/atg/siebel/configurator/spu/generation/template/PromotionConfigurableProductUITemplate.java#2 $$Change: 1194813 $";

  protected String buildID(SiebelCatalogProduct pProduct, ProductUIBuilder pProductUIBuilder)
  {
    return PromotionTemplateUtils.buildId(pProductUIBuilder, super.buildID(pProduct, pProductUIBuilder));
  }
  
  /**
   * set the promotion ui property
   * 
   * @param productUI
  ...
  {
    PromotionTemplateUtils.setExtraProperties(productUI, pProductUIBuilder);
  }
  
  /**
   * copy the promo id to the new ProductUI builder
   * 
   * @param pProductUIBuilder
   * @return
   */
  ...
  {
    if(getProductUIBuilder()==null)
    {
      return pProductUIBuilder;
    }
    else
    {
      PromotionProductUIBuilder prodUiBuilder = (PromotionProductUIBuilder)getProductUIBuilder();
      
      prodUiBuilder.setId(((PromotionProductUIBuilder)pProductUIBuilder).getId());
      
      return prodUiBuilder;
    }
  }
}
