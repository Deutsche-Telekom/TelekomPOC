...
/**
 * @version $Id: //product/Siebel/version/11.2/src/atg/siebel/catalog/mapper/SiebelMappingService.java#2 $$Change: 1194813 $
 * @updated $DateTime: 2015/09/10 08:26:24 $$Author: saysyed $
 *
 */
public interface SiebelMappingService {

  //-------------------------------------
  /** Class version string */

  public static String CLASS_VERSION = "$Id: //product/Siebel/version/11.2/src/atg/siebel/catalog/mapper/SiebelMappingService.java#2 $$Change: 1194813 $";
   ...
   */
  public void setSiebelFileLocation(String siebelFileLocation);

  /**
   * @param pImportFileLocation
   *          File of the import file to use.
   */
  public void setImportFileLocation(File importFileLocation);
	
  public void mapSiebelToAtg() throws MappingException;
	
  public void setJobManager(ImportJobManager pJobStatusService);
