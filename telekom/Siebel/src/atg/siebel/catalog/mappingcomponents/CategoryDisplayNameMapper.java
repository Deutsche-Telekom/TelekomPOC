...
public class CategoryDisplayNameMapper extends BaseMapper {

  //-------------------------------------
  /** Class version string */

  public static String CLASS_VERSION = "$Id: //product/Siebel/version/11.2/src/atg/siebel/catalog/mappingcomponents/CategoryDisplayNameMapper.java#2 $$Change: 1194813 $";
  ...
  public Object mapSiebelToATG(Object pSiebelFields, Map<String, Object> pAttributes) 
    ...
    String displayName = (String) siebelValues[0];
    if (displayName != null && displayName.length() > 0) {
      return displayName;
    }
    String name = (String) siebelValues[1];
