...
public class TranslationIdMapper extends BaseMapper {

  //-------------------------------------
  /** Class version string */

  public static String CLASS_VERSION = "$Id: //product/Siebel/version/11.2/src/atg/siebel/catalog/mappingcomponents/TranslationIdMapper.java#2 $$Change: 1194813 $";
  ...
  public Object mapSiebelToATG(Object pSiebelFields, Map<String, Object> pAttributes) throws MappingException {
    ...
    String generatedId = (String) siebelValues[0];
    String id = (String) siebelValues[1];
