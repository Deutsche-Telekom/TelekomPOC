...
public class SiebelAccountInputBean {
  ...
  public static String CLASS_VERSION = "$Id: //product/Siebel/version/11.2/src/atg/siebel/account/SiebelAccountInputBean.java#2 $$Change: 1194813 $";
  // Account name
  ...
  public void setExpirationMonth(String pExpirationMonth) {
    this.mExpirationMonth = pExpirationMonth;
  }
  ...
  public void setExpirationYear(String pExpirationYear) {
    this.mExpirationYear = pExpirationYear;
  }
