 ...
 * @version $Id: //product/Siebel/version/11.2/src/atg/siebel/configurator/spu/generation/PromotionBlockManager.java#2 $$Change: 1194813 $
...
public class PromotionBlockManager extends BlockManager
{
  ...
  public static String CLASS_VERSION = "$Id: //product/Siebel/version/11.2/src/atg/siebel/configurator/spu/generation/PromotionBlockManager.java#2 $$Change: 1194813 $";
  ...
  {
    String promouiID = ((PromotionProductUIBuilder)pProductUIBuilder).getId();
    return promouiID + "-" + pProductID + "-" + pAttributeID + getAttributeBlockSuffix();
  }
  ...
  {
    String promouiID = ((PromotionProductUIBuilder)pProductUIBuilder).getId();
    return promouiID + "-" + pProductID + "-" + pRelationshipID + getRelationshipBlockSuffix();
  }
  ...
  {
    String promouiID = ((PromotionProductUIBuilder)pProductUIBuilder).getId();
    return promouiID + "-" + pProductId + "-" + pBaseBlockId;
  }
}
