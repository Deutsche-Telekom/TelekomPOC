...
/**
 * <p>Java class for ListOfAccountOrganizationData complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="ListOfAccountOrganizationData">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;sequence>
 *         &lt;element name="AccountOrganization" type="{http://www.siebel.com/SelfService/Common/Contact/Data}AccountOrganizationData" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
...
@XmlType(name = "ListOfAccountOrganizationData", propOrder = {
    "accountOrganization"
})
public class ListOfAccountOrganizationData
    implements Serializable
{

    @XmlElement(name = "AccountOrganization")
    protected List<AccountOrganizationData> accountOrganization;
    @XmlAttribute
     ...
     * {@link AccountOrganizationData }
     * 
     * 
     */
    public List<AccountOrganizationData> getAccountOrganization() {
        if (accountOrganization == null) {
            accountOrganization = new ArrayList<AccountOrganizationData>();
        }
