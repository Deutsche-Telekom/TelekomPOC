...
/**
 * <p>Java class for ListOfContactAccountData complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="ListOfContactAccountData">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;sequence>
 *         &lt;element name="ContactAccount" type="{http://www.siebel.com/SelfService/Common/Contact/Data}ContactAccountData" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
...
@XmlType(name = "ListOfContactAccountData", propOrder = {
    "contactAccount"
})
public class ListOfContactAccountData
    implements Serializable
{

    @XmlElement(name = "ContactAccount")
    protected List<ContactAccountData> contactAccount;
    @XmlAttribute
     ...
     * {@link ContactAccountData }
     * 
     * 
     */
    public List<ContactAccountData> getContactAccount() {
        if (contactAccount == null) {
            contactAccount = new ArrayList<ContactAccountData>();
        }
