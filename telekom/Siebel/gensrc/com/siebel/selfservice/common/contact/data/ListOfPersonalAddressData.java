...
/**
 * <p>Java class for ListOfPersonalAddressData complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="ListOfPersonalAddressData">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;sequence>
 *         &lt;element name="PersonalAddress" type="{http://www.siebel.com/SelfService/Common/Contact/Data}PersonalAddressData" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
...
@XmlType(name = "ListOfPersonalAddressData", propOrder = {
    "personalAddress"
})
public class ListOfPersonalAddressData
    implements Serializable
{

    @XmlElement(name = "PersonalAddress")
    protected List<PersonalAddressData> personalAddress;
    @XmlAttribute
     ...
     * {@link PersonalAddressData }
     * 
     * 
     */
    public List<PersonalAddressData> getPersonalAddress() {
        if (personalAddress == null) {
            personalAddress = new ArrayList<PersonalAddressData>();
        }
