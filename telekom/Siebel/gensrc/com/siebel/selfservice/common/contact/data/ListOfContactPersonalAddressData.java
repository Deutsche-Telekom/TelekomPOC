...
/**
 * <p>Java class for ListOfContactPersonalAddressData complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="ListOfContactPersonalAddressData">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;sequence>
 *         &lt;element name="ContactPersonalAddress" type="{http://www.siebel.com/SelfService/Common/Contact/Data}ContactPersonalAddressData" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
...
@XmlType(name = "ListOfContactPersonalAddressData", propOrder = {
    "contactPersonalAddress"
})
public class ListOfContactPersonalAddressData
    implements Serializable
{

    @XmlElement(name = "ContactPersonalAddress")
    protected List<ContactPersonalAddressData> contactPersonalAddress;
    @XmlAttribute
     ...
     * {@link ContactPersonalAddressData }
     * 
     * 
     */
    public List<ContactPersonalAddressData> getContactPersonalAddress() {
        if (contactPersonalAddress == null) {
            contactPersonalAddress = new ArrayList<ContactPersonalAddressData>();
        }
