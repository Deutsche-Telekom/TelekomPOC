 ...
 *         &lt;element ref="{http://www.siebel.com/SelfService/Common/AccountBillingProfile/Query}ListOfSs_Accountbillingprofile_Io" minOccurs="0"/>
...
@XmlRootElement(name = "SelfServiceAccountBillingProfileQueryPage_Input")
public class SelfServiceAccountBillingProfileQueryPageInput
    implements Serializable
{

    @XmlElement(name = "NamedSearchSpec")
    protected String namedSearchSpec;
    @XmlElement(name = "ListOfSs_Accountbillingprofile_Io", namespace = "http://www.siebel.com/SelfService/Common/AccountBillingProfile/Query")
