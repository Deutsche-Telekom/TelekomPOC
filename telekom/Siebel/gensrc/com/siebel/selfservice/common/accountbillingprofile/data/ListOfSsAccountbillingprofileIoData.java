...
/**
 * <p>Java class for ListOfSs_Accountbillingprofile_IoData complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="ListOfSs_Accountbillingprofile_IoData">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;sequence>
 *         &lt;element name="ComInvoiceProfile" type="{http://www.siebel.com/SelfService/Common/AccountBillingProfile/Data}ComInvoiceProfileData" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
...
@XmlType(name = "ListOfSs_Accountbillingprofile_IoData", propOrder = {
    "comInvoiceProfile"
})
public class ListOfSsAccountbillingprofileIoData
    implements Serializable
{

    @XmlElement(name = "ComInvoiceProfile")
    protected List<ComInvoiceProfileData> comInvoiceProfile;
    @XmlAttribute
     ...
     * {@link ComInvoiceProfileData }
     * 
     * 
     */
    public List<ComInvoiceProfileData> getComInvoiceProfile() {
        if (comInvoiceProfile == null) {
            comInvoiceProfile = new ArrayList<ComInvoiceProfileData>();
        }
