...
/**
 * <p>Java class for ListOfOrderDetailData complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="ListOfOrderDetailData">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;sequence>
 *         &lt;element name="OrderDetail" type="{http://siebel.com/OrderManagement/Order/Details/Data/Data}OrderDetailData" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
...
@XmlType(name = "ListOfOrderDetailData", propOrder = {
    "orderDetail"
})
public class ListOfOrderDetailData
    implements Serializable
{

    @XmlElement(name = "OrderDetail")
    protected List<OrderDetailData> orderDetail;
    @XmlAttribute
    ...
    public List<OrderDetailData> getOrderDetail() {
        if (orderDetail == null) {
            orderDetail = new ArrayList<OrderDetailData>();
        }
