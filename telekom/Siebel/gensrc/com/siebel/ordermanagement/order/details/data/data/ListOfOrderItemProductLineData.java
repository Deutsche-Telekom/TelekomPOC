...
/**
 * <p>Java class for ListOfOrderItemProductLineData complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="ListOfOrderItemProductLineData">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;sequence>
 *         &lt;element name="OrderItemProductLine" type="{http://siebel.com/OrderManagement/Order/Details/Data/Data}OrderItemProductLineData" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
...
@XmlType(name = "ListOfOrderItemProductLineData", propOrder = {
    "orderItemProductLine"
})
public class ListOfOrderItemProductLineData
    implements Serializable
{

    @XmlElement(name = "OrderItemProductLine")
    protected List<OrderItemProductLineData> orderItemProductLine;
    @XmlAttribute
     ...
     * {@link OrderItemProductLineData }
     * 
     * 
     */
    public List<OrderItemProductLineData> getOrderItemProductLine() {
        if (orderItemProductLine == null) {
            orderItemProductLine = new ArrayList<OrderItemProductLineData>();
        }
